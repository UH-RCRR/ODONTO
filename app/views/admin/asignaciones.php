...
<head>
    ...
    <style>
        ...
        /* Buscador Dinámico - EL AJUSTE ESTÁ AQUÍ */
        .search-container {
            background: var(--primary-dark);
            border-radius: 30px;
            padding: 30px;
        ...
        .search-container form {
            position: relative; /* Trae el form al frente */
            z-index: 5;
        }
        ...
        .search-container::after {
            ...
            z-index: 1; /* El diente se queda al fondo */
            pointer-events: none; /* Evita que el diente "bloquee" clics */
        }
    ...
    <div class="search-container shadow-lg text-white">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-3 mb-lg-0">
                ...
                <p class="small opacity-75 mb-0">Ingrese la matrícula para vincular con un docente supervisor.</p>
            </div>
            <div class="col-lg-6">
                <form id="searchForm" class="d-flex gap-2" method="GET" action="index.php">
                    ...
                    <button type="submit" class="btn btn-info px-4 fw-bold text-white shadow" style="border-radius: 15px; z-index: 20; position: relative;">
    ...
    <div class="row">
                        ...
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between">
                                    <h5 class="fw-bold mb-0 text-dark"><?= htmlspecialchars($a['nombreCompleto']) ?></h5>
                                    <span class="badge bg-light text-primary border">ID: <?= htmlspecialchars($a['Matricula']) ?></span>
                                </div>
                                ...
                                <form method="POST" action="index.php?c=asignaciones&a=guardarIndividual">
                                    ...
                                    <input type="hidden" name="nombre" value="<?= htmlspecialchars($a['nombreCompleto']) ?>">
                                    <input type="hidden" name="docente_nombre">
        ...
        <?php elseif (isset($_GET['buscar'])): ?>
            <div class="col-12 text-center py-5">
                <img src="https://cdn-icons-png.flaticon.com/512/3773/3773919.png" alt="No encontrado" style="width: 80px; opacity: 0.5;">
                <h5 class="mt-3 text-muted">No se encontró al alumno en la facultad.</h5>
            </div>
        <?php endif; ?>
    </div>
</div>
